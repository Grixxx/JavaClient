...
public class AddPremiumPieceworksalaryController {
    @FXML
    ...
    public void calculateSalary(ActionEvent event) throws IOException {
        ...
        fiveTextField.getLength() < 1 || fiveTextField.getLength() > 20 || sexTextField.getLength() < 1 && sexTextField.getLength() > 20 ||
                sevenTextField.getLength() < 1 && sevenTextField.getLength() > 20) {
            ...
            fiveTextField.clear();
            sexTextField.clear();
            sevenTextField.clear();

        }else{
            Client.interactionsWithServer.calculatePremiumPieceworkSalary(oneTextField.getText(), twoTextFild.getText(), threeTextField.getText(), fourTextField.getText(),
                    fiveTextField.getText(), sexTextField.getText(), sevenTextField.getText());
