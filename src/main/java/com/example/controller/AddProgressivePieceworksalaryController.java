...
public class AddProgressivePieceworksalaryController {
    @FXML
    ...
    public void calculateSalary(ActionEvent event) throws IOException {
        if (oneTextField.getLength() < 1 || oneTextField.getLength() > 20 || twoTextFild.getLength() < 1 || twoTextFild.getLength() > 20 ||
                ...
                fiveTextField.getLength() < 1 || fiveTextField.getLength() > 20) {
            ...
            Client.interactionsWithServer.calculateProgressivePieceworkSalary(oneTextField.getText(), twoTextFild.getText(), threeTextField.getText(), fourTextField.getText(),
                    fiveTextField.getText());
