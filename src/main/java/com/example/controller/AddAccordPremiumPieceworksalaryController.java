...
public class AddAccordPremiumPieceworksalaryController {
    @FXML
    ...
    public void calculateSalary(ActionEvent event) throws IOException {
        if (oneTextField.getLength() < 1 || oneTextField.getLength() > 20 || twoTextFild.getLength() < 1 || twoTextFild.getLength() > 20 ||
            ...
            Client.interactionsWithServer.calculateAccordPremiumPieceworkSalary(oneTextField.getText(), twoTextFild.getText(), threeTextField.getText(), fourTextField.getText());
