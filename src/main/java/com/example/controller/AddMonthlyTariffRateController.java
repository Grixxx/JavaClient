...
public class AddMonthlyTariffRateController {
    @FXML
    ...
    public void calculateSalary(ActionEvent event) throws IOException {
        if (oneTextField.getLength() < 1 || oneTextField.getLength() > 20 || twoTextFild.getLength() < 1 || twoTextFild.getLength() > 20) {
            ...
            Client.interactionsWithServer.calculateMonthlyTariffRate(oneTextField.getText(), twoTextFild.getText());
            alert.setTitle("Удачно");
            alert.setHeaderText(null);
            alert.setContentText("Вы успешно ввели данные");
            alert.showAndWait();
